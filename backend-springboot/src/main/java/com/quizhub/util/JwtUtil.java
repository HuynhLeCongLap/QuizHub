...
public class JwtUtil {
    ...
    private final String SECRET_KEY = "mySecretKeyForJWTTokenGeneration123456789"; // Use a proper secret in production
    private final int JWT_EXPIRATION = 1000 * 60 * 60 * 10; // 10 hours
